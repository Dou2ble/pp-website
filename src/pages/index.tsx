...
export default function Home() {
  return (
    ...
    >
      ...
      {/* <button className='text-8xl text-right mr-4'>🇬🇧</button> */}

      <div className='mt-[-90px] group absolute top-[50%] left-[50%] -translate-x-1/2 -translate-y-3/4'>
        <img src="/images/pancakeLarge.png" alt="Large Pancake" className='rounded-full transition-transform scale-[2] group-hover:scale-[2.5]'/>
        <div className="font-Silkscreen absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-7xl font-bold text-center transition-transform group-hover:rotate-6 group-hover:scale-[1.3]">
          Pancake Clicker
        </div>
      </div>

          <a href='https://itch.io/' target={"_blank"} className='text-center text-4xl pb-1 bg-blue-500 mt-[650px]'>
        Go to store page ->
      </a>
